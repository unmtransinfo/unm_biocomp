...
/**	The Damerau-Levenshtein distance between two strings can be calculated using
	this class.  This code was copied from:
	http://itssmee.wordpress.com/2010/06/28/java-example-of-damerau-levenshtein-distance/
*/
